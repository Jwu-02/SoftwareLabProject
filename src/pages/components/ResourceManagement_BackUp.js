...
const Projects = () => {
    ...
    //     try{
    //         const response = await fetch('/check_in_hardware',{
    //             method: 'POST',
    //             headers: {
    //                 'Content-Type': 'application/json',
    //             },
    ...
    //         })
    //         const responseData = await response.json();
    //         return responseData.new_avail;
    //     }catch (error) {
    //         console.error('Error:', error);
    //     }
    // }
    // call_fetch().then((data)=>(setavailability(data)));


    // Function to handle button click and toggle text

    // const handleClick = () => {
    //     // Toggle button text between "John" and "Leave"
        // if (buttonText === "Join") {
    ...
    return (
        <div className="auth-form-container">
            <h1>ECE461L: Resource Management</h1>
                ...
                {/*        <button onClick={handleClick2}>{button2Text}</button>*/}
                {/*    </form>*/}
                {/*    <div className="resource-section">*/}
                {/*        <HW_set project_id="2" hwset_num="1" availabiliy="50" cap="100" HW_req={HW1req} setHW_req={setHW1req} setCheckIn_={setCheckIn1} />*/}
                {/*        <HW_set project_id="2" hwset_num="2" availabiliy="70" cap="100" HW_req={HW2req} setHW_req={setHW2req} setCheckIn_={setCheckIn2} />*/}
                ...
                {/*        <button onClick={handleClick3}>{button3Text}</button>*/}
                {/*    </form>*/}
                {/*    <div className="resource-section">*/}
                {/*        <HW_set project_id="3" hwset_num="1" availabiliy="50" cap="100" HW_req={HW1req} setHW_req={setHW1req} setCheckIn_={setCheckIn1} />*/}
                {/*        <HW_set project_id="3" hwset_num="2" availabiliy="70" cap="100" HW_req={HW2req} setHW_req={setHW2req} setCheckIn_={setCheckIn2} />*/}
